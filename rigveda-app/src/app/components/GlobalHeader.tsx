...
// Simple Web search icon component
const WebIcon = ({ className }: { className?: string }) => (
  <svg className={className} width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M6 6c2-4 10-4 12 0" stroke="currentColor" strokeWidth="2"/>
    <path d="M6 18c2 4 10 4 12 0" stroke="currentColor" strokeWidth="2"/>
  </svg>
);
              ...
              <div className="absolute right-0 top-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-50 min-w-48" style={{ colorScheme: 'light' }}>
                <div className="py-1">
                  ...
                  >
                    ...
                    <span className="text-black">Ask AI</span>
                  </Link>
                </div>
              </div>
            )}
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[70vh] sm:max-h-[80vh] overflow-hidden animate-in fade-in-0 zoom-in-95 duration-300" style={{ width: '100%' }}>
            <div className="flex items-center justify-between p-6 border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900">{detailUrl ? 'Preview' : 'Web Search'}</h2>
              ...
              <div className="flex items-center gap-2">
                ...
                {detailUrl && (
                  <a 
                    ...
                    style={{ color: 'var(--primary)', backgroundColor: 'rgba(138, 75, 45, 0.1)' }} 
            ...
            <div className="p-6 max-h-[calc(70vh-120px)] sm:max-h-[calc(80vh-120px)] overflow-y-auto">
              ...
              {detailUrl && (
                <div>
                  ...
                  <div className="mt-4 p-3 rounded-lg text-sm" style={{ backgroundColor: 'rgba(138, 75, 45, 0.1)', color: 'var(--primary)' }}>
        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[70vh] sm:max-h-[80vh] overflow-hidden animate-in fade-in-0 zoom-in-95 duration-300" style={{ width: '100%' }}>
            <div className="flex items-center justify-between p-6 border-b border-gray-100">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: 'rgba(138, 75, 45, 0.15)' }}>
                  <FontAwesomeIcon icon={faSearch} className="text-lg" style={{ color: 'var(--primary)' }} />
                </div>
                <div>
