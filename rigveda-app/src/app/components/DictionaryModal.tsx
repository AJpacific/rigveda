...
export default function DictionaryModal({ open, onClose, initialQuery = '' }: DictionaryModalProps) {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[85vh] overflow-hidden animate-in fade-in-0 zoom-in-95 duration-300 flex flex-col" style={{ width: '100%' }}>
        {/* Header */}
